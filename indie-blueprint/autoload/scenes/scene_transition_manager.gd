...
const voronoi_material = preload("res://indie-blueprint/autoload/scenes/transitions/voronoi_material.tres")

@export var loading_screen_scene: PackedScene = preload("res://indie-blueprint/autoload/scenes/loading/loading_screen.tscn")
