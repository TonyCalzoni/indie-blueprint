...
@icon("res://indie-blueprint/components/interaction/3D/grabbable.svg")
...
@export var outline_shader: Shader = preload("res://indie-blueprint/shaders/environment/pixel_perfect_outline.gdshader")
